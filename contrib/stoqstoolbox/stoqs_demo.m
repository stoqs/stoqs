...
%WILL SHOW THE TWO MOST IMPORTANT FUNCTIONS
    ...
    disp('.');
server='http://odss-staging.shore.mbari.org/canon';
...
stoqs_showall(server)
    ...
    disp('WE MUST KNOW:')
    disp('NAME OF OUR STOQS SERVER : http://odss-staging.shore.mbari.org/canon/stoqs_may2012')
...
stoqs_server='http://odss-staging.shore.mbari.org/canon/stoqs_may2012';
...
platform='dorado';
    ...
    disp('.');
    disp('.');
d=stoqs_down(stoqs_server,dateini,datend,top,bottom,standard,platform);
