...
urlpatterns = patterns('',
    ...
    url(pre + r'instantpointresource.?' + formatPat, 'stoqs.views.showInstantPointResource', {}, name='show-instantpointresource'),
    url(pre + r'measurementresource.?'  + formatPat, 'stoqs.views.showMeasurementResource',  {}, name='show-measurementresource'),
