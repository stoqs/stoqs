...
Script to read data from the John Martin Seabird underway ctd .asc files and 
write them to netCDF files. These files are unpredictable as the CTD operators may not be
experienced or MBARI staff.  Therefore we may need to alter the way the code reads the files. 
...
class ParserWriter(BaseWriter):
 ...
 255.146622    199.000    197.437   3.624085   3.624098     8.9518     8.9525     0.5547    87.0507     4.3842 -9.990e-29     0.9866     0.3700     0.0348  0.0002000     0.0000 1.0000e-12     0.1294     100.00     5.0000    34.0048    34.0044     8.9306     8.9312    26.3499    26.3494 -9.990e-29 -9.990e-29 -9.990e-29         22 0.0000e+00
   	...
   	# Note the delimiter for this run is a tab.  Can be changed for other cruises, formats.  RPM
