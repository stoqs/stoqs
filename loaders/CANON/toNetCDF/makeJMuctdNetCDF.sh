...
./uctdToNetcdf.py -i $LOCALDIR -f Martin_UDAS -p "jhmudas_[0-9][0-9][0-9][0-9][0-9][0-9][0-9].txt" -d 1.5 -t "Underway CTD data from R/V John Martin during CANON - ECOHAB September 2013" 
