...
python monitorLrauv.py -o /mbari/LRAUV/tethys/realtime/sbdlogs/2014/201410 -u 'http://elvis.shore.mbari.org/thredds/catalog/LRAUV/makai/realtime/sbdlogs/2014/201410' -b 'stoqs_september2014' -c 'CANON-ECOHAB - September 2014' --parms  /rhodamine/voltage  --append > $STOQSDIR/loaders/CANON/realtime/monitorLrauv_sep2014_tethys.out 2>&1
...
python monitorLrauv.py -o /mbari/LRAUV/daphne/realtime/sbdlogs/2014/201410 -u 'http://elvis.shore.mbari.org/thredds/catalog/LRAUV/makai/realtime/sbdlogs/2014/201410' -b 'stoqs_september2014' -c 'CANON-ECOHAB - September 2014' --parms  /rhodamine/voltage  --append > $STOQSDIR/loaders/CANON/realtime/monitorLrauv_sep2014_daphne.out 2>&1
