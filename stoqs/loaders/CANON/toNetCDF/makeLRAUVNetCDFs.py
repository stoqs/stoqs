...
SCI_PARMS = {'/':           [{'name': 'concentration_of_colored_dissolved_organic_matter_in_sea_water',
             ...
             'WetLabsBB2FL': [{'name': 'mass_concentration_of_chlorophyll_in_sea_water',
                              ...
                              {"name": "ParticulateBackscatteringCoeff470nm", "rename": "particulatebackscatteringcoeff470nm"},
                              {"name": "ParticulateBackscatteringCoeff650nm", "rename": "particulatebackscatteringcoeff650nm"},
                              ],
