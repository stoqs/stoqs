...
do
    ...
    do
        ...
        python monitorLrauv.py --start '20160831T000000' --end '20161001T000000' -d  'CANON September 2016 Experiment in Monterey Bay' --productDir '/mbari/ODSS/data/canon/2016_Sep/Products/LRAUV' \
