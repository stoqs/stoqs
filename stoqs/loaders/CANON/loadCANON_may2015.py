...
Master loader for all CANON activities in May-June 2015
...
cl = CANONLoader('stoqs_may2015', 'CANON-ECOHAB - MAY 2015',
                    description = 'Spring 2015 Upwelling Front Exploration in Monterey Bay',
                    x3dTerrains = {
...
enddate = datetime.datetime(2015, 6, 6)                  # Fixed end
