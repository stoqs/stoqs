...
declare -a platforms=("tethys" "aku")
...
do
    ...
    latest24plot=''
        ...
        python monitorLrauv.py --start '20170101T000000' --end '20171231T000000' -d  'LRAUV Monterey data - Off Season 2017' --productDir '/mbari/ODSS/data/other/routine/Products/LRAUV' \
