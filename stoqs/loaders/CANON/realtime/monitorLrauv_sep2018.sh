...
do
    ...
    latest24plot=''
        ...
        python monitorLrauv.py --start '20180903T000000' --end '20181231T000000' -d  'LRAUV Monterey data - September 2018' --productDir '/mbari/ODSS/data/other/routine/Products/LRAUV' \
 	--contourDir '/mbari/LRAUV/stoqs' --contourUrl 'http://dods.mbari.org/opendap/data/lrauv/stoqs/' -o /mbari/LRAUV/${platform}/${directory}/ -i /mbari/LRAUV/${platform}/${directory} \
        -u ${urlbase}/${platform}/${search} -b ${database} -c 'LRAUV Monterey data - September 2018'  --append --autoscale \
        --iparm depth \
