...
do
	...
	#fi
        ...
        echo python monitorLrauv.py --start '20160101T000000' -d  'LRAUV Monterey data - Off Season 2016' --productDir '/mbari/ODSS/data/canon/2016_OffSeason/Products/LRAUV' \
