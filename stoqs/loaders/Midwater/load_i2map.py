...
# cl.i2map_base = 'http://dods.mbari.org/opendap/data/auvctd/surveys/2019/netcdf/'
# cl.i2map_files = ['i2map_2019.157.02_1S.nc']
# #cl.i2map_parms = ['seabird25p_temperature']
# cl.i2map_parms = ['navigation_mWaterSpeed']
# cl.load_i2MAP(startdate, enddate, build_attrs=False)
