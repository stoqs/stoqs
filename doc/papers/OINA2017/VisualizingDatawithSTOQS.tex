...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.9\linewidth]{OverviewFirst.png}
...
enables rich graphics and interactivity that can be implemented
by a non-graphics programming experts. Furthermore, X3D's Geospatial component
...
~\ref{fig:Cardboard} where the 3D scene can be viewed on a smart phone to give a rudimentary Virtual 
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.9\linewidth]{ParameterValues.png}
\caption{Parameter Values section expanded with the Temporal section collapsed 
showing histograms of data for a campaign conducted in.}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.9\linewidth]{Isopycnal.png}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.9\linewidth]{Trajectory.png}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.9\linewidth]{TimeseriesProfile.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\linewidth]{Cardboard.png}
